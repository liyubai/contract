...
<div class="Panel" id="Panel1" style="margin-top: 53px;">
	<div class="panelHead"><span>体检信息历史查询</span></div>
	<div class="panelContent">
		<table class="panelTable" border="0" cellspacing="0" cellpadding="0">
			<tbody>
				...
				<td width="180">
				<div style="margin-top:5px;">
					<input style="width:180px;" id="VNation" maxlength="50" class="text ui-widget-content ui-corner-all"/>
				</div>
				</td>
				<td>结论（起始）日期：</td>
				<td width="180">
				...
				<div class="dropDownList">
					...
					<input type="hidden" id="ILevel" name="teachertj.ILevel" value="0" />
				</div>
				<td>发证（起始）日期：</td>
				<td width="180">
				<div style="margin-top:5px;">
				...
				<td width="180">
				<div style="margin-top:5px;">
					<input style="width:180px;" id="DUsedTime" class="text ui-widget-content ui-corner-all" onfocus="WdatePicker({startDate:'%y-%M-%d',dateFmt:'yyyy-MM-dd'})" />
				</div>
				</td>
				<td>有效（截至）日期：</td>
				<td width="180">
				<div style="margin-top:5px;">
					<input style="width:180px;" id="DUsedTime1" class="text ui-widget-content ui-corner-all" onfocus="WdatePicker({startDate:'%y-%M-%d',dateFmt:'yyyy-MM-dd'})" />
				</div>
				</td>
				</tr>
			</tbody>
...
<form id="peopleForm" action="searchTjHistoryListTeacherAction.do" method="post">
<input type="hidden" name="deptId" value="${deptId}" />
<input type="hidden" name="key" value="${key}" />
<input type="hidden" id="VIdf" name="historySearch.VId" />
<input type="hidden" id="VNamef" name="historySearch.VName" />
<input type="hidden" id="ILevelf" name="historySearch.ILevel" />
