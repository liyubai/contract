...
$(function() {
	$("div.dropDownList").find("button").css("width","80px").end().each(function(i){
		...
		else if(i==1){var d=new $.dropDownList(i,true,335);d.button.css("width", "100%");}
		else if(i==2){var d=new $.dropDownList(i,true,335);d.button.css("width", "100%");}
	...
	$("#modalDialogButton4").click(function(){//未确认
		...
		$("#sxcompanyid").val($.trim($("#cxcompanyid").val()));
		$("#steacherid").val($.trim($("#cteacherid").val()));
...
<table border="0" cellspacing="0" cellpadding="3" >
  <tr>
    <td style=" padding-top:8px;">姓名：<input type="text" value="${name}"  id="cName" class="text ui-widget-content ui-corner-all" style="width:40px;" />
     学号：<input type="text"  value="${code}"  id="cVCode" class="text ui-widget-content ui-corner-all" style="width:70px;" />
...
<button>所属公司</button>
<ul>
<li><a href="#N" class="inline" style="width: 75px;" val=""><span class="ui-icon ui-icon-bullet"></span>所属公司</a>
<s:iterator value="dictionCompanyList"><a href="#N"  val="${VId}" class="inline"  style="width: 75px;">${VName}</a>
</s:iterator>
<a href="#N" class="inline" style="width: 75px;" val="0">无</a>
</li> 
</ul><input type="hidden"  id="cxcompanyid" value="${xcompanyid}"/>
</div>
<div class="dropDownList">
<button>教员</button>
<ul>
<li><a href="#N" class="inline" style="width:40px;" val=""><span class="ui-icon ui-icon-bullet"></span>教员</a> <s:iterator value="teacherList">
<a href="#N" val="${VId}" class="inline" style="width:40px;">${VName}</a>
</s:iterator></li>
</ul><input type="hidden"  id="cteacherid" value="${teacherid}"/>
</div>
<button class="normal" id="modalDialogButton4">查询</button></td>
 ...
 <div style="margin-top:30px; margin-left:10px;">
  <table id="usersTable" class="fcolorTable" style="width:1860px;" border="1" bordercolor="#E0E0E0" cellspacing="0" cellpadding="2" >
  ...
  <tbody>
   <s:iterator value="page.data" status="stat">
    <tr>
      ...
      <td align="center">${DStartmoment}</td>
      <td align="center">${DLandmoment}</td>
      <td align="center">${DEndmoment}</td>
      <td align="center">${VNo}</td>
      <td align="center">${DEngineStart}</td>
      <td align="center">${DEngineEnd}</td>
      <td align="center">${ILanddaytimes}</td>
      <td align="center">${ILangnighttimes}</td>
      <td align="right">${DTrantime}</td>
      <td align="right">${VTxy}</td>
      <td align="right">${VLhy}</td>
      ...
      <td colspan="13" align="right">本页总计：</td>
      ...
      <td align="right"><s:property value='page.totalNum.zjtime'/></td>
      <td align="right"><s:property value='page.totalNum.yjtime'/></td>
...
<form  action="open_historyFlightTrainingRecordPageTj.do" method="post" id="searchForm">
...
<input type="hidden" name="xcompanyid" id="sxcompanyid" value="${xcompanyid}">
<input type="hidden" name="teacherid" id="steacherid" value="${teacherid}">
