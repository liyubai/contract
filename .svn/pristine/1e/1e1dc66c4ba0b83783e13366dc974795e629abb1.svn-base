...
<link rel="stylesheet" href="system/themes/cupertino/jquery.ui.all.css">
<script src="system/scripts/jquery.min.js"></script>
<script src="system/scripts/jquery-ui.min.js"></script>
<script src="system/scripts/ui/jquery.ui.position.min.js"></script>
<script src="system/scripts/ui/jquery.ui.core.min.js"></script>
<script src="system/scripts/ui/jquery.ui.widget.min.js"></script>
<script src="system/scripts/ui/jquery.ui.button.min.js"></script>
<script src="system/scripts/ui/jquery.ui.tabs.min.js"></script>
<script src="system/scripts/ui/jquery.ui.dialog.min.js"></script>
<script src="system/scripts/ui/jquery.ui.menu.min.js"></script>
<script src="system/scripts/function.min.js"></script>
<style>
.testDiv { padding: 5px; }
...
.loginFormInput,.btn,.ico,.ico-uid,.ico-pwd{background-image:url(system/themes/cupertino/images/ui-bg_new_login.png)}
...
.error-ft,
.error-arrow,
.error-tt p{background-image: url("system/themes/cupertino/images/ui-bg_new_login_error.png"); _background-image: url("system/themes/cupertino/images/ui-bg_new_login_error.png");}
...
<script src="system/scripts/base.min.js"></script>
</head>
<body onLoad="redirectLoginPage();" class="hide">
<div>
  ...
  <tr>
	...
	<div id="loginWrapper">
		...
		<div id="loginDiv" class="login tab-1 ui-state-default ui-corner-all-4">
			<div class="loginTitle loginTitleNormal"><div class="loginFormCheck" align="center"><br>
            民航大学认证登录</div></div>
			<div class="loginForm">
				 <form id="login" name="login" method="post" action="systemUserSecondLogin.do">
					...
					</div><s:hidden name="redirectTo" value="/system/index.do"/>
				</form>
			</div>
