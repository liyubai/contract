...
// Generated 2016-11-11 10:01:25 by Hibernate Tools 3.5.0.Final
...
public class Contract implements java.io.Serializable {
	...
	public Contract(int CId, String CName, String CContractId) {
		this.CId = CId;
		this.CName = CName;
		this.CContractId = CContractId;
	}

	public Contract(int CId, String CName, String CContractId, Integer CType, Integer CStuType, Integer CStatus,
			Integer CNature, Integer CCompy, String CSignTime, String CPrivateName, String CGradeInfo,
			String CPaymentInfo, Integer CDealPrice, String CTrainCycle, Integer CDelFlg, Integer CInitFlg,
			Date CAddTime, String CAddUser, Date CLastModifyTime, String CLastModifyUser, String CPnameInfo,
			String COntractText) {
		this.CId = CId;
		this.CName = CName;
		this.CContractId = CContractId;
		this.CType = CType;
		this.CStuType = CStuType;
		this.CStatus = CStatus;
		this.CNature = CNature;
		this.CCompy = CCompy;
		this.CSignTime = CSignTime;
		this.CPrivateName = CPrivateName;
		this.CGradeInfo = CGradeInfo;
		this.CPaymentInfo = CPaymentInfo;
		this.CDealPrice = CDealPrice;
		this.CTrainCycle = CTrainCycle;
		this.CDelFlg = CDelFlg;
		this.CInitFlg = CInitFlg;
		this.CAddTime = CAddTime;
		this.CAddUser = CAddUser;
		this.CLastModifyTime = CLastModifyTime;
		this.CLastModifyUser = CLastModifyUser;
		this.CPnameInfo = CPnameInfo;
	...
	public String getCPnameInfo() {
		return this.CPnameInfo;
	}

	public void setCPnameInfo(String CPnameInfo) {
		this.CPnameInfo = CPnameInfo;
	}
