...
*/
	...
	$("#modalDialogButton2").click(function(){
		...
		if(count == 0){
			$("#dialogForm3Warning").html("<br/>请选择要开通的教员！"); //dialogForm3Warning：用于提示警告信息
...
<s:else>
    ...
    <div class="buttonInput relative left" width="120" height="28">
	  ...
	  <s:if test="vcode==null || vcode == ''">
       <input id="tsovcode" name="tsovcode"  type="text" maxlength="50" value="教员编号" title="教员编号"/>  
	  </s:if>
	  <s:else>
	     <input id="tsovcode" name="tsovcode"  type="text" maxlength="50" value="${vcode}"   title="教员编号"/>  
	  </s:else> 
    ...
    <div class="buttonInput relative left" width="160" height="28">
	  ...
	  <s:if test="vname==null || vname == ''">
       <input id="tsovname" name="tsovname"  type="text" maxlength="50" value="姓名/编号" title="姓名/编号"/>  
	  </s:if>
	  <s:else>
	     <input id="tsovname" name="tsovname"  type="text" maxlength="50" value="${vname}"   title="姓名/编号"/>  
	  </s:else> 
...
<div id="dialogForm2">
	<fieldset>
		...
		<div class="panelRight" style="margin-left: 75px;">
			<span style="font-size: 14px; font-weight: bold; color: #555555; line-height:23px;">确定要开通选中的教员账号吗？</span>
		</div>
	</fieldset>	
</div>
...
<form  action="searchTeachersInfoForOpenUserAccount.do" method="post" id="searchForm">
  <input name="vcode" type="hidden" id="searchVcode">
  <input name="vname" type="hidden" id="searchVanme">
  
</form>
<form  action="openTeachersUserAccount.do" method="post" id="deleteForm">
