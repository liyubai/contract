        ...
        <table class="panelTable" border="0" cellspacing="0" cellpadding="2">
        	<thead>
			  ...
			  <tr>
                ...
                <th class="thSortableGray" >毕设合格</th>
                <th class="thSortableGray" >确认日期</th>
			  </tr>   
			</thead>
...
<form  action="saveConfirmGraduationDesign.do" method="post" id="addForm">
<input name="design.IType" type="hidden" value="0">
<input name="design.studentBaseInfo.VId" type="hidden" id="classid">
</form>
