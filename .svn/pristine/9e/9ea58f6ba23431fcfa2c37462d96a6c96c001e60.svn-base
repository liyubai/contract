...
$(function() {
	...
	$("#baseButton").click(function(){
		...
		if(flag>0){
			$("#dialogForm3Warning").html("选择的学员中有已分配基地的，请重新选择。");
	...
	$( "#assignBaseDialog" ).dialog({
		...
		buttons: {
			"确 定": function() {
				...
				$("#DReportdate").val($("#cDReportdate").val());
				if($("#DReportdate").val()==""){
					alert("报到日期不能为空。");
					return;
				}
				$("#DStarttraindate").val($("#cDStarttraindate").val());
				if($("#DStarttraindate").val()==""){
					alert("开训日期不能为空。");
					return;
				}
...
<button class="green"  id="baseButton">分配基地</button>
<button class="green"  id="changeButton">调换基地</button>
</div></s:if>
    ...
    <div class="dropDownList barMiddle">
        ...
        <ul>
            <li><a href="?year=${year}&classNo=${classNo}&isAssignid=1&xstuTypeid=${xstuTypeid}&xcompanyid=${xcompanyid}&xstatusid=${xstatusid}&xxjstatusid=${xxjstatusid}&xformid=${xformid}&xfreetypeid=${xfreetypeid}&name=${name}" val="1"><span class="ui-icon ui-icon-bullet"></span>更多</a></li>
             <li><a href="?year=${year}&classNo=${classNo}&isAssignid=7&xstuTypeid=${xstuTypeid}&xcompanyid=${xcompanyid}&xstatusid=${xstatusid}&xxjstatusid=${xxjstatusid}&xformid=${xformid}&xfreetypeid=${xfreetypeid}&name=${name}" val="2">满足送配条件</a></li>
             <li><a href="?year=${year}&classNo=${classNo}&isAssignid=7&xstuTypeid=${xstuTypeid}&xcompanyid=${xcompanyid}&xstatusid=${xstatusid}&xxjstatusid=${xxjstatusid}&xformid=${xformid}&xfreetypeid=${xfreetypeid}&name=${name}" val="3">成绩审查不合格</a></li>
             <li><a href="?year=${year}&classNo=${classNo}&isAssignid=7&xstuTypeid=${xstuTypeid}&xcompanyid=${xcompanyid}&xstatusid=${xstatusid}&xxjstatusid=${xxjstatusid}&xformid=${xformid}&xfreetypeid=${xfreetypeid}&name=${name}" val="9">身体审查不合格</a></li>
             <li><a href="?year=${year}&classNo=${classNo}&isAssignid=7&xstuTypeid=${xstuTypeid}&xcompanyid=${xcompanyid}&xstatusid=${xstatusid}&xxjstatusid=${xxjstatusid}&xformid=${xformid}&xfreetypeid=${xfreetypeid}&name=${name}" val="10">在校表现不合格</a></li>
             
            <li><a href="?year=${year}&classNo=${classNo}&isAssignid=4&xstuTypeid=${xstuTypeid}&xcompanyid=${xcompanyid}&xstatusid=${xstatusid}&xxjstatusid=${xxjstatusid}&xformid=${xformid}&xfreetypeid=${xfreetypeid}&name=${name}" val="4">已分配</a></li>
            <li><a href="?year=${year}&classNo=${classNo}&isAssignid=5&xstuTypeid=${xstuTypeid}&xcompanyid=${xcompanyid}&xstatusid=${xstatusid}&xxjstatusid=${xxjstatusid}&xformid=${xformid}&xfreetypeid=${xfreetypeid}&name=${name}" val="5">未分配</a></li>
            <s:iterator value="baseList" status="i">
            <li><a href="?year=${year}&classNo=${classNo}&isAssignid=${i.count+6}&xstuTypeid=${xstuTypeid}&xcompanyid=${xcompanyid}&xstatusid=${xstatusid}&xxjstatusid=${xxjstatusid}&xformid=${xformid}&xfreetypeid=${xfreetypeid}&name=${name}" val="${i.count+6}">${VName}</a></li>
              </s:iterator>
...
<div class="panelContent">
    <table class="panelTable" id="usersTable" border="0" cellspacing="0" cellpadding="3">
        ...
        <s:iterator value="page.data" status="stat">
 			<s:if test="outlineName==null || outlineName==''">
...
<div id="changeBaseDialog"  title="调换基地">
...
<span class="panelLine"></span>
    选择基地： 
     <s:iterator value="baseList">
      <input name="changeBaseName" type="radio" value="${VId}"><b></b>${VName}&nbsp;&nbsp;&nbsp;&nbsp;
     </s:iterator>
    <span class="panelLine"></span>
    调换日期： 
...
<div id="assignBaseDialog"  title="分配基地">
    ...
    <span class="panelLine"></span>
	报到日期： <input type="text"  id="cDReportdate" class="Wdate ui-widget-content ui-corner-all text"  style="width:100px; border-color:#DDDDDD; height:16px;" onFocus="WdatePicker({cDReportdate:'%y-%M-%d',dateFmt:'yyyy-MM-dd'})" value="${viewDate}" onKeyPress="return false" onpaste="return false" />
    <span class="panelLine"></span>
	开训日期： <input type="text"  id="cDStarttraindate" class="Wdate ui-widget-content ui-corner-all text"  style="width:100px; border-color:#DDDDDD; height:16px;" onFocus="WdatePicker({cDStarttraindate:'%y-%M-%d',dateFmt:'yyyy-MM-dd'})" value="${viewDate}" onKeyPress="return false" onpaste="return false" />
    <span class="panelLine"></span>
    ...
    选择基地：
     <s:iterator value="baseList">
      <input name="baseName" type="radio" value="${VId}"><b></b>${VName}&nbsp;&nbsp;&nbsp;&nbsp;
     </s:iterator>
</div>
...
<tr>
<td width="10%" height="90" align="left" valign="middle"><img src="themes/cupertino/images/warning.png" /></td>
<td width="90%" align="left" valign="middle"><span style="font-size: 14px; font-weight: bold; color: #555555; line-height:23px;">确认取消所选学员分配的基地吗？</span></td>
</tr>
</table>
</fieldset>
</div>
...
<form action="saveStudentAssignBase.do" method="post" id="assignForm">
<input type="hidden"  name="assifnBase.VId" id="VIds">
<input type="hidden"  name="assifnBase.TOrg.VId" id="orgid">
<input type="hidden"  name="assifnBase.DReportdate" id="DReportdate">
<input type="hidden"  name="assifnBase.DStarttraindate" id="DStarttraindate">
<input type="hidden"  name="assifnBase.DAssigntime" id="DAssigntime">
</form>

<form action="saveStudentChangeBase.do" method="post" id="changeForm">
<input type="hidden"  name="changedbase.VId" id="cVIds">
<input type="hidden"  name="changedbase.TOrgByVNewbaseid.VId" id="corgid">
<input type="hidden"  name="changedbase.DChangedtime" id="DChangedtime">
</form>

<form  action="escStudentAssignBase.do" method="post" id="escForm">
