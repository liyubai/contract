...
$(function() {
	...
	$("#allButton").click(function(){
		...
		window.location.replace("open_accordAllCondtionList.do");
	});
});
</script>
...
<button class="green"  id="allButton">完全符合国内送陪条件的学生列表</button>
</div></s:if>
...
<li><a href="?ysipass=0&xkipass=${xkipass}&jfipass=${jfipass}&cjaudit=${cjaudit}&staudit=${staudit}&bxaudit=${bxaudit}" val="0">雅思>=4.5</a></li>
<li><a href="?ysipass=1&xkipass=${xkipass}&jfipass=${jfipass}&cjaudit=${cjaudit}&staudit=${staudit}&bxaudit=${bxaudit}" val="1">雅思<4.5</a></li>
</ul>
<input type="hidden"  id="ysipass" value="${ysipass}"/>
</div>
<div class="dropDownList barMiddle">
<button>英语等级测试</button><span class="bar"></span>
<ul>
<li><a href="?xkipass=&ysipass=${ysipass}&jfipass=${jfipass}&cjaudit=${cjaudit}&staudit=${staudit}&bxaudit=${bxaudit}" val=""><span class="ui-icon ui-icon-bullet"></span>英语等级测试</a></li>
<li><a href="?xkipass=0&ysipass=${ysipass}&jfipass=${jfipass}&cjaudit=${cjaudit}&staudit=${staudit}&bxaudit=${bxaudit}" val="0">英语>=3</a></li>
<li><a href="?xkipass=1&ysipass=${ysipass}&jfipass=${jfipass}&cjaudit=${cjaudit}&staudit=${staudit}&bxaudit=${bxaudit}" val="1">英语<3</a></li>
</ul>
...
<input name="name" type="hidden" id="searchKey" value="">

<input name="xstuTypeid" type="hidden" value="">
<input name="xcompanyid" type="hidden" value="">
<input name="xstatusid" type="hidden" value="">
<input name="xxjstatusid" type="hidden" value="">
<input name="xformid" type="hidden" value="">
<input name="xfreetypeid" type="hidden" value="">
<input name="isAssignid" type="hidden" value="">
