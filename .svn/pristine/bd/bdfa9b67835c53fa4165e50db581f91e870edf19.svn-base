...
function Calendar(beginYear, endYear, language, patternDelimiter, date2StringPattern, string2DatePattern) {
	...
	this.colors = {"bg_cur_day":"#9fb8f5","bg_over":"#EFEFEF","bg_out":"#fbbb57"}
};
...
Calendar.prototype.draw = function() {
	...
	this.form.selectTodayButton.onclick = function () {
	    ...
	    var oldVal=calendar.dateControl.value;/*ls*/
        ...
        var newVal=calendar.dateControl.value;/*ls*/
				if(oldVal!=newVal){/*ls*/
				$("#dialogForm1").dialog("open");;/*ls*/
				}/*ls*/
	...
	for(var i = 0; i < tds.length; i++) {
		...
		if (dateArray[i]){
			tds[i].onclick = function () {
				...
				document.getElementById('selDate').innerHTML=newVal;
				}
				calendar.hide();
			}
...
document.writeln('<div id="__calendarPanel" style="position:absolute;visibility:hidden;z-index:9999;background-color:#FFFFFF;border:1px solid #ddd;width:200px;height:225px;">');
...
__ci.document.writeln('select {font-size:12px;background-color:#fff; border:1px solid #ddd}');
__ci.document.writeln('table {border:0px solid #e2eefe;background-color:#fff}');
__ci.document.writeln('th {font-size:12px;font-weight:normal;background-color:#fff;}');
__ci.document.writeln('th.theader {font-weight:normal;background-color:#aeabab;color:#fff;width:24px;}');
...
__ci.document.writeln('td.sat {color:#0000FF;background-color:#bfd4ec;}');
__ci.document.writeln('td.sun {color:#FF0000;background-color:#bfd4ec;}');
__ci.document.writeln('td.normal {background-color:#bfd4ec;}');
__ci.document.writeln('input.l {border: 1px solid #e2eefe;background-color:#ddd;width:20px;height:20px;}');
__ci.document.writeln('input.r {border: 1px solid #e2eefe;background-color:#ddd;width:20px;height:20px;}');
__ci.document.writeln('input.b {border: 1px solid #e2eefe;background-color:#ddd;width:100%;height:20px;}');
__ci.document.writeln('-->');
