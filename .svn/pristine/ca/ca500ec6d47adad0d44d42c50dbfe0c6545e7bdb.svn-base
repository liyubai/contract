...
<table width="50%" class="fcolorTable" border="1" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td colspan="3" align="center" bgcolor="#99CC00" >飞行教员分类统计表（汇总表）</td>
    </tr>
  <tr>
    <td width="173" align="center" bgcolor="#CCFFCC">单发</td>
    <td width="145" align="center" bgcolor="#CCFFCC">多发</td>
    <td width="146" align="center" bgcolor="#CCFFCC">仪表-飞机</td>
    </tr>
