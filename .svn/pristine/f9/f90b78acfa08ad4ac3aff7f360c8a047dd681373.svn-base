...
$(function() {
	...
	$("#escid0").click(function(){
		window.location.replace("open_studentBaseInfoList.do?pageIndex="+$("#pageIndex").val());
	});
	...
	$("#saveone").click(function(){
		...
		$.ajax({
			...
			success:function(data){
				...
				alert(data.message);
				//window.location.replace("open_editStudentBaseInfoPage.do?id=" + data.VId);
			},
			error:function(){
		...
		<table class="panelTable" border="0" cellspacing="0" cellpadding="0">
			...
			<tbody>
			  <tr class="normal">
				...
				<td width="120"><div style="margin-top:5px;"><input id="cVName" type="text" class="text ui-widget-content ui-corner-all" style="width:100px;"  value="${student.VName}"/></div></td>
				...
				<td width="120" ><div class="dropDownList">
				  ...
				  <input type="hidden" id="cVGender" value="${student.VGender}" />
				</div></td>
				<td width="70" align="right">身份证号：</td>
				<td width="120"><div style="margin-top:5px;"><input id="cVCardid" type="text" class="text ui-widget-content ui-corner-all" style="width:150px;" value="${student.VCardid}" /></div></td>
				<td width="70" align="right">出生年月：</td>
				<td><input type="text"  id="cDBirthday" class="Wdate ui-widget-content ui-corner-all text"  style="width:180px; border-color:#DDDDDD; height:16px;" onFocus="WdatePicker({startDate:'%y-%M-%d',dateFmt:'yyyy-MM-dd'})" value='<s:date name="student.DBirthday" format="yyyy-MM-dd" />'  onKeyPress="return false" onpaste="return false" /></td>
			  </tr>
			  <tr class="normal">
				...
				<td><div class="dropDownList">
				  ...
				  <input type="hidden" id="cVStuTypeid" value="${student.TDictionByVStuTypeid.VId}" />
				</div></td>
				<td align="right">学号：</td>
				<td><div style="margin-top:5px;"><input id="cVCode" type="text" class="text ui-widget-content ui-corner-all" style="width:100px;" value="${student.VCode}" /></div></td>
				<td align="right">入校班级：</td>
				<td><input type="text" id="cVClassNoid" class="text ui-widget-content ui-corner-all" style="width:150px;" value="${student.VClassNoid}"/><div class="dropDownList"></div></td>
				<td align="right">生源地：</td>
				<td><div style="margin-top:5px;"><input id="cVSyd"  value="${student.VSyd}"  type="text" class="text ui-widget-content ui-corner-all" style="width:180px;"/></div></td>
			  </tr>
			  <tr class="normal">
				<td align="right">入校年月：</td>
				<td>
                <input type="text"  id="cDRxsj" class="Wdate ui-widget-content ui-corner-all text"  style="width:100px; border-color:#DDDDDD; height:16px;" onFocus="WdatePicker({startDate:'%y-%M-%d',dateFmt:'yyyy-MM-dd'})" value='<s:date name="student.DRxsj" format="yyyy-MM-dd" />' onKeyPress="return false" onpaste="return false" />
                </td>
				<td align="right">离校年月：</td>
				<td><input type="text"  id="cDLxsj" class="Wdate ui-widget-content ui-corner-all text"  style="width:100px; border-color:#DDDDDD; height:16px;" onFocus="WdatePicker({startDate:'%y-%M-%d',dateFmt:'yyyy-MM-dd'})"  value='<s:date name="student.DLxsj" format="yyyy-MM-dd" />' onKeyPress="return false" onpaste="return false" /></td>
				...
				<td><div class="dropDownList">
				  ...
				  <input type="hidden" id="cVStuStatusid" value="${student.TDictionByVStuStatusid.VId}"  />
				</div></td>
				<td align="right">联系方式：</td>
				<td><div style="margin-top:5px;"><input id="cVLxfs" value="${student.VLxfs}" type="text" class="text ui-widget-content ui-corner-all" style="width:180px;"/></div></td>
			  </tr>
			  <tr class="normal">
				...
				<td><div class="dropDownList">
				  ...
				  <input type="hidden" id="cVFormid"  value="${student.TDictionByVFormid.VId}" />
				</div></td>
				...
				<td><div class="dropDownList">
				  ...
				  <input type="hidden" id="cVFreeTypeid"  value="${student.TDictionByVFreeTypeid.VId}" />
				</div></td>
				...
				<td><div class="dropDownList">
				  ...
				  <input type="hidden" id="cVXjStatusid"  value="${student.TDictionByVXjStatusid.VId}" />
				</div></td>
				<td align="right">毕业院校：</td>
                
				<td><div style="margin-top:5px;"><input id="cVByyx" value="${student.VByyx}" type="text" class="text ui-widget-content ui-corner-all" style="width:180px;"/></div>
                </td>
			  </tr>
               <tr class="normal">
				...
				<td><div class="dropDownList">
				  ...
				  <input type="hidden" id="cVCompanyid"  value="${student.TOrg.VId}"/>
				</div></td>
				...
				<td><div class="dropDownList">
				  ...
				  <input type="hidden" id="cVZzmm"  value="${student.VZzmm}" />
				</div></td>
				...
				<td><div class="dropDownList">
				  ...
				  <input type="hidden" id="cVNationid" value="${student.TDictionByVNationid.VId}" />
				</div></td>
				<td align="right">家庭住址：</td>
				<td><div style="margin-top:5px;"><input id="cVJtzz"  value="${student.VJtzz}" type="text" class="text ui-widget-content ui-corner-all" style="width:180px;"/></div></td>
			  </tr>
                <tr class="normal">
				...
				<td><div class="dropDownList">
				  ...
				  <input type="hidden" id="cVWhcd" value="${student.TDictionByVWhcd.VId}" />
				</div></td>
				...
				<td><div class="dropDownList">
				  ...
				  <input type="hidden" id="cVEnlevel" value="${student.VEnlevel}" />
				</div></td>
				...
				<td><div class="dropDownList">
						...
						<ul>
                            ...
                            <a href="#N" val="${VId}" class="inline" style="width:45px;">${VName}</a>
						  </s:iterator></li>
						</ul>
				  <input type="hidden" id="cVJg" value="${student.VJg}"  />
				</div></td>
				<td align="right">专业：</td>
				<td><div style="margin-top:5px;"><input id="cVZy" value="${student.VZy}"  type="text" class="text ui-widget-content ui-corner-all" style="width:180px;"/></div></td>
			  </tr>
                <tr class="normal">
                  ...
                  <td><s:if test="student.photo==null || student.photo==''"><img id="imgid" width="70" height="100"></s:if>
                  <s:else>
                  <img id="imgid" width="70" height="100" src="../attachment/${student.photo}">
                  </s:else>
                  </td>
                  <td align="right">&nbsp;</td>
                  <td>&nbsp;</td>
...
<form id="unitSubjectForm" method="post" action="updateStudentBaseInfo.do">
<input type="hidden" name="student.VId" value="${student.VId}" />
...
<input type="hidden" name="student.photo" id="photoid" value="${student.photo}" />

<input type="hidden" name="student.openStatus" value="${student.openStatus}" />
<input type="hidden" name="student.IUsertype" value="${student.IUsertype}" />
<input type="hidden" name="student.DCreatedate" value="${student.DCreatedate}" />
<input type="hidden" name="student.ITjexam" value="${student.ITjexam}" />
<input type="hidden" name="student.DTjexamdate" value="${student.DTjexamdate}" />
<input type="hidden" name="student.TUser.VId" value="${student.TUser.VId}" />
<input type="hidden" name="pageIndex" value="${pageIndex}"  id="pageIndex"/>
</form>
