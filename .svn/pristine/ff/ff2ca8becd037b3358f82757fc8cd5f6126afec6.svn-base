...
$(function() {
	...
	var code = id.split(",")[1];
	var name = id.split(",")[2];
	var gender = id.split(",")[4];
	$("#codeid").html(code);
	$("#nameid").html(name);
	$("#genderid").html(gender);
	$("#cVCardid").val(id.split(",")[3]);
	$("#studentid").val(id.split(",")[0]);
	...
	<div class="panelContent">
		...
		<table class="panelTable" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr class="normal">
				...
				<td width="180"><span id="codeid"></span></td>
				<td width="60" align="right">姓名：</td>
				<td width="180"><span id="nameid"></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;性别：<span id="genderid"></span></td>
				<td width="80" align="right">照片：</td>
				<td width="180"><s:if test="student.photo==null || student.photo==''"></s:if><s:else><img id="imgid" width="70" height="100" src="../attachment/${student.photo}"></s:else></td>
			  </tr>
			  ...
			  <div style="margin-top:5px;">
					<input style="width:150px;" id="cVCardid" class="text ui-widget-content ui-corner-all"/>
				</div>
				</td>
				<td width="60" align="right">有效期：</td>
				<td width="180">
				<div style="margin-top:5px;">
					<input style="width:160px;border-color:#DDDDDD;height:14px;" id="cDEffectdate" class="Wdate text ui-widget-content ui-corner-all" onFocus="WdatePicker({startDate:'%y-%M-%d',dateFmt:'yyyy-MM-dd'})" />
				</div>
				</td>
				<td width="80" align="right">局长授权签发：</td>
				<td width="180">
				<div style="margin-top:5px;">
					<input style="width:160px;" id="cVIssuer" class="text ui-widget-content ui-corner-all"/>
				</div>
				</td>
				</tr>
				<tr class="normal">
				...
				<td width="180">
				<div style="margin-top:5px;">
					<input style="width:150px;" id="cVCompany"  value="中国民用航空总局" class="text ui-widget-content ui-corner-all"/>
				</div>
				</td>
				<td width="60" align="right">签发日期：</td>
				<td width="180">
				<div style="margin-top:5px;">
					<input style="width:160px;border-color:#DDDDDD;height:14px;" id="cDIssuetime"  class="Wdate text ui-widget-content ui-corner-all" onFocus="WdatePicker({startDate:'%y-%M-%d',dateFmt:'yyyy-MM-dd'})" />
				</div>
				</td>
				<td width="80" align="right">更新日期：</td>
				<td width="180">
				<div style="margin-top:5px;">
					<input style="width:160px;border-color:#DDDDDD;height:14px;" id="cDUpdatedate"  class="Wdate text ui-widget-content ui-corner-all" onFocus="WdatePicker({startDate:'%y-%M-%d',dateFmt:'yyyy-MM-dd'})" />
				</div>
				</td>
				</tr>
				<tr class="normal">
				...
				<td width="180"><div class="dropDownList">
						...
						<input type="hidden" id="clevelid"  value="${ehid}"/>
					</div>
				...
				<td width="180">
					<div class="dropDownList">
						...
						<input type="hidden" id="cVBeizhu" value="1" />
					</div>
				</td>
				...
				<td width="180">
					<div class="dropDownList">
						...
						<input type="hidden" id="cVZhizhaoxingzhi" value="正式执照" />
					</div>
				</td>
				</tr>
				...
				<div style="margin-top:5px;">
					<s:iterator value="hkqLbList">
						<input type="radio" name="hkqlb" value="${VId}" onClick="doit('${VId}')"/><b></b>${VName}　
					</s:iterator>
				</div>
				</td>
				</tr>
				...
				<div style="margin-top:5px;">
					<s:iterator value="ybDjList">
						<input type="checkbox" name="ybjb" value="${VId}"/><b></b>${VName}　
					</s:iterator>
				</div>
				</td>
				</tr>
				...
				<div style="margin-top:5px;">
					<s:iterator value="fjJbList">
						<input type="checkbox" name="fjjb" value="${VId}"/><b></b>${VName}　
					</s:iterator>
				</div>
				</td>
				</tr>
				...
				<div style="margin-top:5px;">
					<s:iterator value="xyjJbList">
						<input type="checkbox" name="xyjjb" value="${VId}"/><b></b>${VName}　
					</s:iterator>
				</div>
				</td>
				</tr>
				...
				<div style="margin-top:5px;">
					<s:iterator value="hkqXbList">
						<input type="checkbox" name="hkqjb" value="${VId}"/><b></b>${VName}　
					</s:iterator>
				</div>
				</td>
				</tr>
...
<form id="addForm" action="saveStudentLicense.do" method="post">
<input type="hidden" name="license.studentBaseInfo.VId" id="studentid">
...
<input type="hidden" name="license.VHangkongqileibie" id="VHangkongqileibie"><!--航空器类别-->
