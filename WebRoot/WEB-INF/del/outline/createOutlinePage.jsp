		...
		<table class="panelTable" border="0" cellspacing="0" cellpadding="0">
			...
			<tbody>
			  <tr class="normal">
				...
				<td colspan="3"><div style="margin-top:5px;"><input id="cVCode" type="text" class="text ui-widget-content ui-corner-all" style="width:320px;" /></div></td>
				<td align="right">大纲名称：</td>
				<td colspan="3"><div style="margin-top:5px;"><input id="cVName" type="text" class="text ui-widget-content ui-corner-all" style="width:316px;" /></div></td>
			  </tr>
			  <tr class="normal">
				<td width="90" align="right" style="height:39px;">版 本 号：</td>
				<td width="100"><div style="margin-top:5px;"><input id="cVBc" type="text" class="text ui-widget-content ui-corner-all" style="width:100px;" value="R0" /></div></td>
				<td width="60">单元数量：</td>
				<td width="100"><div style="margin-top:5px;"><input id="cIUnits" type="text" class="text ui-widget-content ui-corner-all" style="width:100px;" value="0" /></div></td>
				<td width="80" align="right">阶段数量：</td>
				<td width="100"><div style="margin-top:5px;"><input id="cIStages" type="text" class="text ui-widget-content ui-corner-all" style="width:100px;" value="0" /></div></td>
				<td width="80" align="right">课程数量：</td>
				<td><div style="margin-top:5px;"><input id="cILessons" type="text" class="text ui-widget-content ui-corner-all" style="width:100px;" value="0" /></div></td>
			  </tr>
			 
			  <tr class="normal">
				<td align="right">飞行训练时间：</td>
				<td><div style="margin-top:5px;"><input id="cDTraintime" type="text" class="text ui-widget-content ui-corner-all" style="width:100px;"  onMouseDown="deletebMF('cDTraintime')" onBlur="viewLongTime('cDTraintime')" /></div></td>
				<td>飞机时间：</td>
				<td><div style="margin-top:5px;"><input id="cDPlanetime" type="text" class="text ui-widget-content ui-corner-all" style="width:100px;" onMouseDown="deletebMF('cDPlanetime')" onBlur="viewLongTime('cDPlanetime')" /></div></td>
				<td align="right">训练器时间：</td>
				<td><div style="margin-top:5px;"><input id="cDTrainningdevicetime" type="text" class="text ui-widget-content ui-corner-all" style="width:100px;" onMouseDown="deletebMF('cDTrainningdevicetime')" onBlur="viewLongTime('cDTrainningdevicetime')" /></div></td>
				<td align="right">模拟机时间：</td>
				<td><div style="margin-top:5px;"><input id="cDMonijitime" type="text" class="text ui-widget-content ui-corner-all" style="width:100px;"   onMouseDown="deletebMF('cDMonijitime')" onBlur="viewLongTime('cDMonijitime')" /></div></td>
			  </tr>
			 
               <tr class="normal">
				<td align="right">仪表等级：</td>
				<td colspan="3"><input name="yibiaoName" type="checkbox"  value="1"><b></b>仪表(飞机)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="yibiaoName" type="checkbox" value="2"><b></b>仪表(直升机)</td>
				<td align="right">训练设备：</td>
				<td colspan="3"><input name="shebeiName" type="checkbox" value="1"><b></b>飞机&nbsp;&nbsp;&nbsp;&nbsp;<input name="shebeiName" type="checkbox" value="2"><b></b>训练器</td>
			  </tr>
 <tr class="normal">
				<td align="right">多发等级：</td>
				<td colspan="7"><input name="duofaName" type="checkbox" value="1"><b></b>单发陆地&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="duofaName" type="checkbox" value="2"><b></b>多发陆地&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="duofaName" type="checkbox" value="3"><b></b>单发水上&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="duofaName" type="checkbox" value="4"><b></b>多发水上 </td>
			  </tr>
 <tr class="normal">
				<td align="right">训练机型：</td>
				<td colspan="7"><s:iterator value="planeformList">
				  <input name="jixingName" type="checkbox" value="${VId}"><b></b>${VName}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</s:iterator>
			    </td>
			  </tr>

			  <tr class="normal">
				<td align="right">使用范围：</td>
				<td colspan="3"><textarea  id="cVRange" style="width:330px;height:300px;" class="text ui-widget-content ui-corner-all"></textarea></td>
				<td align="right">课程目标：</td>
				<td colspan="3"><textarea  id="cVTarget" style="width:330px;height:300px;" class="text ui-widget-content ui-corner-all"></textarea></td>
			  </tr>
			  <tr class="normal">
				<td align="right">进入条件：</td>
				<td colspan="3"><textarea  id="cVConditions" style="width:330px;height:300px;" class="text ui-widget-content ui-corner-all"></textarea></td>
				<td align="right">训练周期：</td>
				<td colspan="3"><textarea  id="cVTraincycle" style="width:330px;height:300px;" class="text ui-widget-content ui-corner-all"></textarea></td>
			  </tr>
			  <tr class="normal">
			    <td align="right">转学规定：</td>
			    <td colspan="3"><textarea  id="cVChangeschool" style="width:330px;height:300px;" class="text ui-widget-content ui-corner-all"></textarea></td>
			    <td align="right">训练终止：</td>
			    <td colspan="3"><textarea  id="cVStoptrain" style="width:330px;height:300px;" class="text ui-widget-content ui-corner-all"></textarea></td>
		      </tr>
               <tr class="normal">
			    <td align="right">训练成绩评定：</td>
			    <td colspan="3"><textarea  id="cVScorejudge" style="width:330px;height:300px;" class="text ui-widget-content ui-corner-all"></textarea></td>
			    <td align="right">培训方法：</td>
			    <td colspan="3"><textarea  id="cVTrainmethod" style="width:330px;height:300px;" class="text ui-widget-content ui-corner-all"></textarea></td>
		      </tr>
			  <tr class="normal">
			    <td align="right">训练记录：</td>
			    <td colspan="7"><textarea  id="cVTrainrecord" style="width:330px;height:300px;" class="text ui-widget-content ui-corner-all"></textarea></td>
		      </tr>
			</tbody>
		</table>
...
<form id="unitSubjectForm" method="post" action="createOutline.do">
