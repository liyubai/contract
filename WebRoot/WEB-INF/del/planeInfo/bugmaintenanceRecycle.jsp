	...
	$("#modalDialogButton3").click(function(){
		...
		for(i=0;i<r1.length;i++){
			if(r1[i].checked==true){
				...
				jc =  $("#times" + (i+1)).val();
				str+=r1[i].value.split(",")[0] + ";" + shichang + ";" + shijian + ";" + kongzhong + ";" + times + ";" + jc +",";
...
<s:if test="#r==null || #r==0">
    <button id="modalDialogButton3" class="green">机务异常回收</button>
 </s:if>
		...
		<table class="panelTable" id="usersTable" border="0" cellspacing="0" cellpadding="3">
            ...
            <s:iterator value="planeinfoList" status="i">
			  <tr class="normal">
                ...
                <td><input id="cDEngineStart${i.count}" class="borders"  type="text" maxlength="6"  /></td>
...
<form  action="saveBugMaintenanceRecycle.do" method="post" id="repairResultForm">
<input name="deviceType" type="hidden" value="${deviceType}">
