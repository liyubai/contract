...
$(function() {
	...
	$("#modalDialogButton4").click(function(){
		...
		$("#searchForm").attr("action","open_flightTrainingRecordCompletionPageTj.do");
		$("#searchForm").submit();
	});
	$("#exportid").click(function(){
		...
		$("#flyMoment").val($.trim($("#DFlymoment").val()));
		$("#endMoment").val($.trim($("#DEndmoment").val()));
		$("#searchForm").attr("action","exportDataFlightTrainingRecordCompletion.do");
		$("#searchForm").submit();
	});
});
...
<div class="left">
训练日期从：<input type="text"  id="DFlymoment" class="Wdate ui-widget-content ui-corner-all text"  style="width:100px; border-color:#DDDDDD; height:16px;" onFocus="WdatePicker({DFlymoment:'%y-%M-%d',dateFmt:'yyyy-MM-dd'})"  onKeyPress="return false" onpaste="return false"   value="${flyMoment}"/>
    到 <input type="text"  id="DEndmoment" class="Wdate ui-widget-content ui-corner-all text"  style="width:100px; border-color:#DDDDDD; height:16px;" onFocus="WdatePicker({DEndmoment:'%y-%M-%d',dateFmt:'yyyy-MM-dd'})"  onKeyPress="return false" onpaste="return false"  value="${endMoment}" />
</div>
 <div class="buttonInput relative left" width="180" height="28">
    <input id="searchUser" value="${name}" name="searchUser"  type="text" maxlength="50" /><button id="modalDialogButton4" >查询</button>
 </div>
 <button class="normal" id="exportid">导出</button>
</div>
...
<form  action="open_flightTrainingRecordCompletionPageTj.do" method="post" id="searchForm">
