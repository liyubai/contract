...
<table width="50%" class="fcolorTable" border="1" cellspacing="0" cellpadding="0">
  <tr>
    <td width="140" rowspan="2" align="center">序号</td>
    <td colspan="2" align="center" bgcolor="#99CC00" >整体课程学生执照持照情况（汇总表）</td>
    </tr>
  <tr>
    <td width="173" align="center" bgcolor="#CCFFCC">执照名称</td>
    <td width="291" align="center" bgcolor="#CCFFCC">学生数量</td>
    </tr>
 
    <tr>
      <td align="center">1</td>
      <td align="center">学生执照</td>
      <td align="center">${viewOrg.xue}</td>
    </tr>
 	<tr>
      <td align="center">2</td>
      <td align="center">私照</td>
      <td align="center">${viewOrg.si}</td>
    </tr>
     <tr>
      <td align="center">3</td>
      <td align="center">商照</td>
      <td align="center">${viewOrg.shang}</td>
    </tr>
     <tr>
      <td colspan="2" align="center">合计</td>
      <td align="center">${viewOrg.heji}</td>
    </tr>
</table>
