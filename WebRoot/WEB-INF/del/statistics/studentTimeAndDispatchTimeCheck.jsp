...
<table width="80%" class="fcolorTable" border="1" cellspacing="0" cellpadding="0">
  <tr>
    <td width="152" rowspan="2" align="center">飞行日期</td>
    <td colspan="7" align="center" bgcolor="#99CC00" >学生时间与签派时间与机务时间校验</td>
    </tr>
  <tr style="white-space:nowrap;">
    <td width="107" align="center" bgcolor="#CCFFCC">飞机</td>
    <td width="112" align="center" bgcolor="#CCFFCC">学生飞行时间</td>
    <td width="111" align="center" bgcolor="#CCFFCC">签派时间</td>
    <td width="115" align="center" bgcolor="#CCFFCC">机务时间</td>
    <td width="134" align="center" bgcolor="#CCFFCC">学生与签派误差</td>
    <td width="146" align="center" bgcolor="#CCFFCC">学生与机务误差</td>
    <td width="153" align="center" bgcolor="#CCFFCC">签派与机务误差</td>
  </tr>
