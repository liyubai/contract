...
<div class="Panel" id="Panel1" style="margin-top: 5px;">
	...
	<div class="panelContent">
		...
		<table class="panelTable" border="0" cellspacing="0" cellpadding="0">
			...
			<tbody>
			  <tr class="normal">
				<td width="60" align="right">学生状态：</td>
				...
				<td width="80" align="right">学籍状态：</td>
				<td width="120" ><div class="dropDownList">
						<button>请选择</button>
						<ul>
				...
				<td width="120"><div style="margin-top:5px;"></div></td>
				<td width="70" align="right">&nbsp;</td>
				<td>&nbsp;</td>
			  </tr>
			  ...
			  <tr class="normal">
               ...
               <tr class="normal">
                ...
                <input type="hidden" name="student.stuStatusName" id="zhuangtai" />
                <input type="hidden" name="student.xjStatusName" id="xueji" />
                 <input type="hidden" name="student.formName" id="xingshi" />
                 <input type="hidden" name="student.freeTypeName" id="feiyong" />
                ...
                <tr class="normal">
                  <td align="right"><button class="green" primary="ui-icon-button-confirm" onClick="upload()" id="importid" >导入</button></td>
                  <td colspan="4" style="padding-top:6px;"><span id="importing"></span></td>
                  <td></td>
                  <td align="right">&nbsp;</td>
                  <td>&nbsp;</td>
                </tr>
...
function upload(){
	...
	$("#zhuangtai").val($("#cVStuStatusid").val());
	$("#xueji").val($("#cVXjStatusid").val());
	$("#xingshi").val($("#cVFormid").val());
	$("#feiyong").val($("#cVFreeTypeid").val());
	$("#tFileForm").submit();
	$("#importing").html("<img src=\"themes/cupertino/images/loading.gif\"   border=\"0\" />");
