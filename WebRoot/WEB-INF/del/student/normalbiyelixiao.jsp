...
$(function() {
	...
	for(i=0;i<ss.length;i++){
		...
		content+="<td><input type=\"text\" id=\"cname0"+i+"\" class=\"Wdate ui-widget-content ui-corner-all text\" style=\"width:95px;border-color:#DDDDDD; height:16px;\" onFocus=\"WdatePicker({cname1"+i+":'%y-%M-%d',dateFmt:'yyyy-MM-dd'})\" /></td>";
        ...
        <table class="panelTable" border="0" cellspacing="0" cellpadding="2">
        	<thead>
			  ...
			  <tr>
                ...
                <th class="thSortableGray" >毕业证日期</th>
                <th class="thSortableGray" >实际离校日期</th>
                <th class="thSortableGray" ></th>
			  </tr>   
			</thead>
...
<form  action="saveStudentGraduationOffSchool.do" method="post" id="addForm">
<input name="off.studentBaseInfo.VId" type="hidden" id="classid">
</form>
