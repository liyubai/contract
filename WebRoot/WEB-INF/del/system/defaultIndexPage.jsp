...
<body class="hide">
<div id="indexHead">
<div style="height:52px; background-position:right; background-repeat:no-repeat; background-image:url(themes/cupertino/images/top.jpg)">
...
<td width="215" valign="top"><span style="color:#1F6CA4;font-size:12px; "><s:property value="%{#session.loginContext.realName}"/> | <!--<a href="javascript:void(0)" onClick="changePsw()" class="blue" style="font-size:12px;">修改密码</a>|--><a href="../logout.do" class="blue" style="font-size:12px;">退出</a></span></td>
</tr>
</table>
</div>
<div id="tabs" style="background-position:right; height:38px; background-repeat:no-repeat; background-image:url(themes/cupertino/images/top_bottom.jpg)">
<ul>
...
<div class="tabDiv" id="tabDiv9"></div>
</div>
</div>
