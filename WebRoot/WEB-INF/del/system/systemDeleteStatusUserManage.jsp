...
<s:if test="#r==null || #r==0">
	<button id="modalDialogButton4" class="green" primary="ui-icon-button-addperson">恢复账号</button></s:if>
...
<form  action="searchDeleteStatusUserAccount.do" method="post" id="searchForm">
...
<form  action="recoverUserAccountForDeleteStatus.do" method="post" id="recoverForm">
