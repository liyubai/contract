		...
		*/
		...
		if(errors==""){
			...
			if(pd != null && pd != "" && pd != "null"){
				if(confirm("该教员已经存在执照信息，确认保存执照信息？\r如果保存将覆盖原执照信息将！")){
					$("#peopleForm").submit();
				}
			}else{
				$("#peopleForm").submit();
		...
		<table class="panelTable" border="0" cellspacing="0" cellpadding="0">
			<tbody>
			  ...
			  <div style="margin-top:5px;">
					<input style="width:180px;" id="VCardid" name="teacherZz.VCardid" value="${aoru}" maxlength="50" class="text ui-widget-content ui-corner-all"/>
				</div>
				</td>
				<td width="60" align="right">有效期：</td>
				<td width="180">
				<div style="margin-top:5px;">
					<input style="width:180px;border-color:#DDDDDD;" id="DEffectdate" name="teacherZz.DEffectdate" value="" class="Wdate text ui-widget-content ui-corner-all" onFocus="WdatePicker({startDate:'%y-%M-%d',dateFmt:'yyyy-MM-dd'})" />
				</div>
				</td>
				...
				<td width="180">
				<div style="margin-top:5px;">
					<input style="width:180px;border-color:#DDDDDD;" id="VCompany" name="teacherZz.VCompany" value="中国民用航空总局" maxlength="100" class="text ui-widget-content ui-corner-all"/>
				</div>
				</td>
				<td width="60" align="right">签发日期：</td>
				<td width="180">
				<div style="margin-top:5px;">
					<input style="width:180px;border-color:#DDDDDD;" id="DIssuetime" name="teacherZz.DIssuetime" value="" class="Wdate text ui-widget-content ui-corner-all" onFocus="WdatePicker({startDate:'%y-%M-%d',dateFmt:'yyyy-MM-dd'})" />
				</div>
				</td>
				<td width="80" align="right">更新日期：</td>
				<td width="180">
				<div style="margin-top:5px;">
					<input style="width:180px;border-color:#DDDDDD;" id="DUpdatedate" name="teacherZz.DUpdatedate" value="" class="Wdate text ui-widget-content ui-corner-all" onFocus="WdatePicker({startDate:'%y-%M-%d',dateFmt:'yyyy-MM-dd'})" />
				</div>
				</td>
				</tr>
				<tr class="normal">
				...
				<td width="180">
					<div class="dropDownList">
						...
						<input type="hidden" id="IHgz" name="teacherZz.IHgz" value="2" />
					</div>
				</td>
				...
				<td width="180">
					<div class="dropDownList">
						...
						<input type="hidden" id="IJiankong" name="teacherZz.IJiankong" value="1" />
					</div>
				</td>
				...
				<td width="180">
					<div class="dropDownList">
						...
						<input type="hidden" id="VXingzhi" name="teacherZz.VXingzhi" value="正式执照" />
					</div>
				</td>
				</tr>
                <!--
				...
				<tr class="normal">
				<td width="90" align="right">飞行教员等级：</td>
				<td colspan="5">
				<div style="margin-top:5px;">
				...
				<tr class="normal">
				<td width="90" align="right">运输航空公司飞行教员执照等级：</td>
				<td colspan="5">
				  <div style="margin-top:5px;">
...
<input type="hidden" id="pd" value="${teacherZz.DEffectdate}" />
</body>
</html>
