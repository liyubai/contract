...
<table class="panelTable" border="0" cellspacing="0" cellpadding="0">
    <tbody>
        ...
        <td width="90" align="right">局长授权签发：</td>
        <td width="180">
        <div style="margin-top:5px;">
        ...
        <tr class="normal">
        <td align="right">教员执照等级：</td>
        <td colspan="5">
        <div style="margin-top:5px;">
            <s:iterator value="jyzzDjList">
                <input type="checkbox" name="VDengji" <s:if test="teacherZz.VDengji != null && (teacherZz.VDengji).contains(VId)">checked</s:if> value="${VId}"/><b></b>${VName}　
            </s:iterator>
        </div>
        </td>
        </tr>
        <tr class="normal">
        <td align="right">教员执照类型：</td>
        <td colspan="5">
        <div style="margin-top:5px;">
        ...
        <tr class="normal">
        <td width="80" align="right">运输航空公司飞行教员执照等级：</td>
        <td colspan="5">
          <div style="margin-top:5px;">
...
<form id="peopleForm" action="upZzTeacherAction.do" method="post">
