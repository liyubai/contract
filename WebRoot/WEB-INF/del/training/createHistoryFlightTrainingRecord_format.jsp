...
$(function() {
	...
	$("div.dropDownList").find("button").css("width","120px").end().each(function(i){
		...
		else if(i==6){var d=new $.dropDownList(i,true,330);d.button.css("width", "97px");}
...
<div class="panelContent"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" >
  <tr>
    ...
    <ul>
    <s:iterator value="olist" status="statu">
    <li>
    ...
    <td width="9%" align="right">开车时刻：</td>
    <td width="10%"><div class="buttonInput" style="width:90px;height:26px; border-color:#DDDDDD"> 
    <input id="cDFlymoment" title="示例 0708"  style="width:85px;"  type="text" maxlength="4" value="示例 0708"   onMouseDown="deletebMF('cDFlymoment')" />
    </div></td>
    <td width="9%" align="right">关车时刻：</td>
    <td>
     <div class="buttonInput" style="width:85px;height:26px; border-color:#DDDDDD">
    <input id="cDEndmoment" title="示例 0840"  style="width:85px;"  type="text" maxlength="4" value="示例 0840" onMouseDown="deletebMF('cDEndmoment')" />
    </div>
    </td>
  ...
  <tr>
    ...
    <td align="right">教员在座：</td>
    <td><input name="isSeat" type="radio" value="0" checked><b></b>是 <input name="isSeat" type="radio" value="1"><b></b>否</td>
    <td align="right">监视教员：</td>
		...
		<table id="usersTable" class="colorTable" border="1" bordercolor="#E0E0E0" cellspacing="0" cellpadding="2">
			...
			<tbody>
              ...
              <td align="center"><input type="text"  id="cILangnighttimes" value="0" class="text ui-widget-content ui-corner-all"  style="width:20px;" /></td>
				...
				<td align="center"><input type="text"  name="cflight" class="text ui-widget-content ui-corner-all" value="朝阳"  style="width:50px;" /></td>
...
<input type="hidden" name="unitid" id="sunitid2">
<input type="hidden" name="phaseid" id="sphaseid2">
<input type="hidden" name="lessonid" id="slessonid2">
</form>
