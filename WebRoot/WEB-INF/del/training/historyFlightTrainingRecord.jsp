...
$(function() {
	$("div.dropDownList").find("button").css("width","80px").end().each(function(i){
		...
		else if(i==1){var d=new $.dropDownList(i,true,360);d.button.css("width", "100%");}
		else if(i==2){var d=new $.dropDownList(i,true,320);d.button.css("width", "100%");}
...
<table border="0" cellspacing="0" cellpadding="3" >
  <tr>
    <td style=" padding-top:8px;">姓名：<input type="text"  value="${name}"  id="cName" class="text ui-widget-content ui-corner-all" style="width:60px;" />
...
<form  action="open_historyFlightTrainingRecordPage.do" method="post" id="searchForm">
