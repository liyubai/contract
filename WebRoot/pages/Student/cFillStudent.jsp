...
<div id="rightPartA" style="overflow-x:hidden;">
	...
	<input type="hidden" name="strCompany" id="strCompany" value="0" maxlength="25"/>
                ...
                <tr>
                    ...
                    <td class="col20_">
                    <input id="strContractNo" name="strContractNo" type="text" class="tableinput" />
                ...
                <tr>
                    <td colspan="4" class="tCenter">
                        ...
                        <input id="Button1" type="submit" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary ml10" value="返回" />
                    </td>
                </tr>
            </table>
            </form>
