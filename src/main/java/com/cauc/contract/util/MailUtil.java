 ...
 *@(#)MailUtil.java
 *version :1.0
 *Copyright (c) 黑龙江海康软件工程有限公司  版权所有
 *
 *Create by: zhaochunhui 2008-12-4上午08:45:31
 *
 *Modified By:
 *
 */
...
public class MailUtil {
	 ...
	 * @throws MessagingException
	 */
	public static void sendTextMessage(Session session, String from,
	...
	/**
	 * This method overrides the sendTextMessage to specify only one receiver
	 * and cc recipients, rather than an array of recipients.
	 * 
	 * @param from
	 ...
	 * @param cc
	 *            e-mail address of cc recipient
	 * @param subject
	 *            subject of e-mail
	 * @param content
	 ...
	 *             the exception to indicate failure
	 */
	public static void sendHTMLMessage(Session session, String from,
			String[] to, String[] cc, String[] bcc, String subject,
			String content) throws MessagingException {
		sendMessage(session, from, to, cc, bcc, subject, content,
	...
	public static void sendHTMLMessage(Session session, String from, String to, String subject, String content)
		...
		sendMessage(session, from, recipient, null, null, subject, content,
				"text/html; charset=utf-8");
	}	
}
